...
export default function NewInvoiceScreen() {
    ...
    const fetchCustomers = async () => {
        ...
        try {
            ...
            setCustomerId(response.data.data[0]?.id || 0);
                    ...
                    <section className="p-4">
                        <form className="space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <div className="flex  justify-between"> {/* Flex container for title and button */}
                                        <div>
                                            Customer
                                        </div>
                                        <Link
                                            href="/customers/create" // The path to your new screen
                                            className="w-40 flex justify-end text-primary text-lg font-bold"
                                ...
                                <div>
                                    ...
                                    <Popover open={open} onOpenChange={setOpen}>
                                        <PopoverTrigger asChild>
                                            ...
                                            >
                                                {dueDate instanceof Date ? dueDate.toLocaleDateString() : "Pick a date"}
                                            ...
                                            <div className="grid grid-cols-2 gap-4 mb-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="relative">
                                                        <Input
                                                            id="price-1" min="0" step="0.01" value={item.unitPrice} onChange={(e) => updateItem(item.id, 'unitPrice', e.target.value)} />
                                                    </div>
                                                </div>
                                            </div>
